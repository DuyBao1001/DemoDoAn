...
namespace NewsApp.Common
{
    public static class MessageProtocol
    {
        public static class RequestCommand
        {
            ...
            // C?P NH?T M?I CHO QUÊN M?T KH?U
            public const string FORGOT_PASSWORD = "FORGOT_PASSWORD"; // G?i Email ?? yêu c?u nh?n mã OTP
            public const string RESET_PASSWORD = "RESET_PASSWORD";   // G?i Email + OTP + Pass M?i ?? xác nh?n ??i
        ...
        public static class ResponseCommand
        {
            ...
            //C?P NH?T M?I CHO QUÊN M?T KH?U
            public const string FORGOT_PASSWORD_SUCCESS = "FORGOT_PASSWORD_SUCCESS"; // Email t?n t?i, ?ã g?i OTP
            public const string FORGOT_PASSWORD_FAIL = "FORGOT_PASSWORD_FAIL";       // Email không t?n t?i ho?c l?i g?i mail

            public const string RESET_PASSWORD_SUCCESS = "RESET_PASSWORD_SUCCESS";   // OTP ?úng, ?ã ??i pass
            public const string RESET_PASSWORD_FAIL = "RESET_PASSWORD_FAIL";         // OTP sai ho?c l?i h? th?ng
