...
namespace NewsApp.DAL
{
    internal class AccountRepository : BaseRepository<Account>, IAccountRepository
    {
        ...
        // 1. Hàm kiểm tra Email có tồn tại không
        ...
        // 2. Hàm cập nhật mật khẩu mới
        // Nhớ using Common; và using Microsoft.Data.SqlClient;

        public bool UpdatePassword(string email, string newPasswordPlain)
        {
            try
            {
                // 1. Mã hóa mật khẩu
