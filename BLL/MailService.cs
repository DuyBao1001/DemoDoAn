...
public class MailService
{
    ...
    public static bool SendOTP(string toEmail, string otpCode)
    {
        try
        {
            ...
            mail.From = new MailAddress(_fromEmail, "Hệ Thống Tin Tức"); // Tên hiển thị
            mail.To.Add(toEmail);
            ...
            SmtpClient smtp = new SmtpClient("smtp.gmail.com", 587); // Gmail dùng port 587
            smtp.EnableSsl = true; // Bắt buộc phải có SSL
